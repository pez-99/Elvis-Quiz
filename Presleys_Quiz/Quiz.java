...
public class Quiz implements ActionListener {
    ...
    public Quiz() {
        ...
        answer_labelA.setForeground(new Color(222, 49, 99));
        answer_labelA.setFont(new Font("MV Boli", Font.PLAIN, 35));
        

        answer_labelB.setBounds(125, 200, 500, 100);
        answer_labelB.setBackground(new Color(219,112,147));
        answer_labelB.setForeground(new Color(222, 49, 99));
        answer_labelB.setFont(new Font("MV Boli", Font.PLAIN, 35));
        

        answer_labelC.setBounds(125, 300, 500, 100);
        answer_labelC.setBackground(new Color(219,112,147));
        answer_labelC.setForeground(new Color(222, 49, 99));
        answer_labelC.setFont(new Font("MV Boli", Font.PLAIN, 35));
        

        answer_labelD.setBounds(125, 400, 500, 100);
        answer_labelD.setBackground(new Color(219,112,147));
        answer_labelD.setForeground(new Color(222, 49, 99));
        answer_labelD.setFont(new Font("MV Boli", Font.PLAIN, 35));
        
        secs_left.setBounds(535, 510, 100, 100);
